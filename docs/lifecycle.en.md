...
The lock file records name, tool, version, source, git HEAD, and `SKILL.md` hash. Policy checks cover total skills, never-used rate, duplicate installs, source coverage, and safety findings. The policy file is local data and can be edited to fit your team.
