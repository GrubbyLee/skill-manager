...
- **知识图谱**：把 skill / MCP / 分类 / 同源套件 / 平台关系导出为 JSON、Mermaid 或单文件 HTML 可视化图谱
...
- **搜索过滤**：搜索框会在当前勾选关系形成的子图中继续过滤 skill、分类和平台
...
- 图太密时：取消“同类”“共享平台”，或拖动右侧节点把密集区域拉开
